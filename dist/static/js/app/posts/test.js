...
define("juicer", (function (global) {
    return function () {
        var ret, fn;
        return ret || global.juicer;
    };
}(this)));
...
require(['zepto', 'juicer','util'], function($, juicer, util) {
    console.log("zepto:", $);
    console.log("juicer:", juicer);
    util.say();
    console.log("it works!");
});
define("app/posts/test", function(){});
